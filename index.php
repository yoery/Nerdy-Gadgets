...
<head>
    ...
    <style>
        ...
        .section-ervaring {width: 95%;
            ...
            align-items: flex-start;
            background-color: #cfcfdc;}
        .h2-ervaring {text-align: center; width:100%; color: black; margin-bottom: 20px;}
        ...
        .producten {            width: 95%;
            ...
            align-items: flex-start;
            background-color: #cfcfdc;}
        .h2-producten1 {text-align: center; width: 100%; margin-bottom: 10px;}
        .product-info1 {            
            width: 400px;
            height: 450px;
            margin: 20px;
