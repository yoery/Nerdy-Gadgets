...
<body>
    ...
    <center>
        <section style="width: 800px; height: 500px; margin-top: 50px; border-radius: 10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <img src="images/1715465.jpg" style="width: 150px; height: 250px; margin-top: 30px; border-radius: 10px;">
            <img src="images/1857490.jpg" style="width: 150px; height: 250px; margin-top: 30px; border-radius: 10px;">
            <img src="images/1748730.jpg" style="width: 200px; height: 250px; margin-top: 30px; border-radius: 10px;">
            <h5 style="color: black; margin-top: 20px; width: 700px;">De Galaxy A-serie heeft er een nieuwe ster bij: de Galaxy A53 5G Zwart.
    ...
    <section>
        <div class="samsung-container">
            ...
            <div class="row">
                <div class="column">
                    <img class="demo cursor" src="images/samsung1.png" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
                </div>
                <div class="column">
                    <img class="demo cursor" src="images/samsung%20side1.png" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
                </div>
                <div class="column">
                    <img class="demo cursor" src="images/samsung%20side2.png" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
                </div>
            </div>
        </div>
